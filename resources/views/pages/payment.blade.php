...
<!-- Mirrored from remtsoy.com/tf_templates/tf-bookify-demo/flight-payment-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jul 2018 11:03:15 GMT -->
<head>
        ...
        <div class="navbar-inner nav">
          ...
          <div class="collapse navbar-collapse" id="navbar-main">
            <ul class="nav navbar-nav">
              <li class="dropdown">
                <a class="dropdown-toggle" href="index-2.html" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pages</a>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <ul class="dropdown-meganav-list-items">
                        ...
                        <li>
                          <a href="index-3.html">Index 2</a>
                        </li>
                        <li>
                          <a href="index-4.html">Index 3</a>
                        </li>
                        <li>
                          <a href="index-5.html">Index 4</a>
                        </li>
                        <li>
                          <a href="index-6.html">Index 5</a>
                        </li>
                        <li>
                          <a href="index-7.html">Index 6</a>
                        </li>
                        <li>
                          <a href="index-8.html">Index 7</a>
                        </li>
                        <li>
                          <a href="index-9.html">Index 8</a>
                        </li>
                        <li>
                          <a href="index-10.html">Index 9</a>
                        </li>
                        <li>
                          <a href="index-11.html">Index 10</a>
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-4">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                <a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img class="navbar-flag" src="{{ asset('bookify/img/flags/USA.png') }}" alt="Image Alternative text" title="Image Title"/>
                </a>
                <div class="dropdown-menu dropdown-menu-xxl">
                  ...
                  <div class="row" data-gutter="10">
                    <div class="col-md-3">
                      <ul class="dropdown-meganav-select-list-lang">
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/UK.png') }}" alt="Image Alternative text" title="Image Title"/>English(UK)
                          </a>
                        </li>
                        <li class="active">
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/US.png') }}" alt="Image Alternative text" title="Image Title"/>English(US)
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/DE.png') }}" alt="Image Alternative text" title="Image Title"/>Deutsch
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/NED.png') }}" alt="Image Alternative text" title="Image Title"/>Nederlands
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/FR.png') }}" alt="Image Alternative text" title="Image Title"/>Français
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/SP.png') }}" alt="Image Alternative text" title="Image Title"/>Español
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/ARG.png') }}" alt="Image Alternative text" title="Image Title"/>Español (AR)
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/IT.png') }}" alt="Image Alternative text" title="Image Title"/>Italiano
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/PT.png') }}" alt="Image Alternative text" title="Image Title"/>Português (PT)
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/BR.png') }}" alt="Image Alternative text" title="Image Title"/>Português (BR)
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/NR.png') }}" alt="Image Alternative text" title="Image Title"/>Norsk
                          </a>
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-3">
                      <ul class="dropdown-meganav-select-list-lang">
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/FIN.png') }}" alt="Image Alternative text" title="Image Title"/>Suomi
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/SW.png') }}" alt="Image Alternative text" title="Image Title"/>Svenska
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/DEN.png') }}" alt="Image Alternative text" title="Image Title"/>Dansk
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/CZ.png') }}" alt="Image Alternative text" title="Image Title"/>Čeština
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/HUN.png') }}" alt="Image Alternative text" title="Image Title"/>Magyar
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/ROM.png') }}" alt="Image Alternative text" title="Image Title"/>Română
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/JP.png') }}" alt="Image Alternative text" title="Image Title"/>日本語
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/CN.png') }}" alt="Image Alternative text" title="Image Title"/>简体中文
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/PL.png') }}" alt="Image Alternative text" title="Image Title"/>Polski
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/GR.png') }}" alt="Image Alternative text" title="Image Title"/>Ελληνικά
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/RU.png') }}" alt="Image Alternative text" title="Image Title"/>Русский
                          </a>
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-3">
                      <ul class="dropdown-meganav-select-list-lang">
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/TUR.png') }}" alt="Image Alternative text" title="Image Title"/>Türkçe
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/BUL.png') }}" alt="Image Alternative text" title="Image Title"/>Български
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/ARB.png') }}" alt="Image Alternative text" title="Image Title"/>العربية
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/KOR.png') }}" alt="Image Alternative text" title="Image Title"/>한국어
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/ISR.png') }}" alt="Image Alternative text" title="Image Title"/>עברית
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/LAT.png') }}" alt="Image Alternative text" title="Image Title"/>Latviski
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/UKR.png') }}" alt="Image Alternative text" title="Image Title"/>Українська
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/IND.png') }}" alt="Image Alternative text" title="Image Title"/>Bahasa Indonesia
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/MAL.png') }}" alt="Image Alternative text" title="Image Title"/>Bahasa Malaysia
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/TAI.png') }}" alt="Image Alternative text" title="Image Title"/>ภาษาไทย
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/EST.png') }}" alt="Image Alternative text" title="Image Title"/>Eesti
                          </a>
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-3">
                      <ul class="dropdown-meganav-select-list-lang">
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/CRO.png') }}" alt="Image Alternative text" title="Image Title"/>Hrvatski
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/LIT.png') }}" alt="Image Alternative text" title="Image Title"/>Lietuvių
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/SLO.png') }}" alt="Image Alternative text" title="Image Title"/>Slovenčina
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/SERB.png') }}" alt="Image Alternative text" title="Image Title"/>Srpski
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/SLOVE.png') }}" alt="Image Alternative text" title="Image Title"/>Slovenščina
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/NAM.png') }}" alt="Image Alternative text" title="Image Title"/>Tiếng Việt
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/PHI.png') }}" alt="Image Alternative text" title="Image Title"/>Filipino
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="{{ asset('bookify/img/flag_codes/ICE.png') }}" alt="Image Alternative text" title="Image Title"/>Íslenska
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div class="row" data-gutter="20">
                    ...
                    <div class="col-md-3 ">
                      <div class="theme-search-results-item-img-wrap">
                        <img class="theme-search-results-item-img _mob-h" src="{{ asset('bookify/img/airline-logo/aa.jpg') }}" alt="Image Alternative text" title="Image Title"/>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row row-col-gap" data-gutter="20">
                      ...
                      <div class="col-md-6 ">
                        <ul class="theme-payment-page-card-list">
                          <li>
                            <img src="{{ asset('bookify/img/credit-icons/mastercard-straight-64px.png') }}" alt="Image Alternative text" title="Image Title"/>
                          </li>
                          <li>
                            <img src="{{ asset('bookify/img/credit-icons/visa-straight-64px.png') }}" alt="Image Alternative text" title="Image Title"/>
                          </li>
                          <li>
                            <img src="{{ asset('bookify/img/credit-icons/visa-electron-straight-64px.png') }}" alt="Image Alternative text" title="Image Title"/>
                          </li>
                          <li>
                            <img src="{{ asset('bookify/img/credit-icons/discover-straight-64px.png') }}" alt="Image Alternative text" title="Image Title"/>
                          </li>
                          <li>
                            <img src="{{ asset('bookify/img/credit-icons/maestro-straight-64px.png') }}" alt="Image Alternative text" title="Image Title"/>
                          </li>
                          <li>
                            <img src="{{ asset('bookify/img/credit-icons/american-express-straight-64px.png') }}" alt="Image Alternative text" title="Image Title"/>
                          </li>
                        </ul>
                      </div>
                    </div>
